  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row-reverse">
      ...
      <div className="md:w-1/2 flex flex-col justify-between bg-background p-6 sm:px-8 lg:px-12">
          ...
          <div className="max-w-md w-full space-y-6">
            ...
            <form className="space-y-6 w-full sm:w-[96%]" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-2 px-4 rounded-3xl cursor-pointer gradient-primary text-primaryForeground font-medium shadow hover:scale-105 transition-all disabled:opacity-70"
              >
              ...
              <div className="flex justify-around gap-2 ">
                <div className="flex border dark:bg-background p-2 px-4 hover:scale-105 hover:bg-background/80 rounded-lg items-center gap-3 cursor-pointer transition-all">
                  <img
                    className="h-6 w-6"
        ...
        {/* Footer */}
        <footer className="text-center md:py-4 pt-12 text-xs text-gray-400 border-t">
