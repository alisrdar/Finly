            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
                    ...
                    <div className="md:col-span-3 col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="w-8 h-8 bg-hover-muted hover:bg-primary rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110">
                ...
                <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center">
                    <div className="text-muted-foreground text-sm mb-4 md:mb-0">
                        © 2025 Finly. All rights reserved. Built with ❤️ for better financial management.
                    </div>
