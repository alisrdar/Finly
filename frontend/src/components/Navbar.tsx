...
const Navbar = ({ activeMenu, onClick }: { activeMenu: string, onClick: () => void }) => {
  ...
  return (
    <>
      {/* Main Navbar */}
      <div className=' flex items-center gap-4 bg-card/95 backdrop-blur-xl backdrop-saturate-150 border-b border-gray-200/50 dark:border-gray-700/50 py-4 px-4 md:px-8 sticky top-0 z-50 shadow-sm'>
